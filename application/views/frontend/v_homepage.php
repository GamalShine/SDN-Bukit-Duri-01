      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              SDN BUKIT DURI 01 Jakarta Selatan
            </p>
    ...
    <div class="container">
      ...
      <div class="row">
        <?php foreach($fasilitas as $f){ ?>
          <div class="col-md-4">
            <div class="work-box">
              <a href="<?php echo base_url() ?>gambar/fasilitas/<?php echo $f->fasilitas_gambar; ?>" data-lightbox="gallery-mf">
                <div class="work-img">
                  <img src="<?php echo base_url(); ?>gambar/fasilitas/<?php echo $f->fasilitas_gambar; ?>" alt="" class="img-fluid">
                </div>
                <div class="work-content">
                  <div class="row">
                    <div class="col-sm-8">
                      <h2 class="w-title"><?php echo $f->fasilitas_nama; ?></h2>
                    </div>
                    <div class="col-sm-4">
                      <div class="w-like">

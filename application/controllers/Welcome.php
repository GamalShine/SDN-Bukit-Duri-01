...
class Welcome extends CI_Controller {
	...
	{		
		...
		$kategori = $this->db->query("SELECT * FROM kategori WHERE kategori_slug='$slug'")->row();
		$data['kategori_nama'] = $kategori ? $kategori->kategori_nama : 'Kategori';
	...
	public function kelulusan()
	{
		...
		$this->load->view('frontend/v_header',$data);
		$this->load->view('frontend/v_kelulusan',$data);
		$this->load->view('frontend/v_footer',$data);
	}

	public function kelulusan_cek()
	{
		// data pengaturan website
		$data['pengaturan'] = $this->m_data->get_data('pengaturan')->row();
